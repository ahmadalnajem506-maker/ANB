...
self.addEventListener('install', event => {
  console.log('🔧 Service Worker installing v3.88...');
  event.waitUntil(
    caches.open(CACHE_NAME).then(cache => {
      console.log('✅ Cache opened v3.88');
...
self.addEventListener('activate', event => {
  console.log('🚀 Service Worker activating v3.88...');
  event.waitUntil(
...
console.log('✨ ANB FinAdmin Service Worker Loaded v3.88 - Cache Updated!');
