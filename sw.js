...
self.addEventListener('install', event => {
  console.log('🔧 Service Worker installing v3.33...');
  event.waitUntil(
    caches.open(CACHE_NAME).then(cache => {
      console.log('✅ Cache opened v3.33');
...
self.addEventListener('activate', event => {
  console.log('🚀 Service Worker activating v3.33...');
  event.waitUntil(
...
console.log('✨ ANB FinAdmin Service Worker Loaded v3.33 - Cache Updated!');
