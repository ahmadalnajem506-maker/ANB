...
self.addEventListener('install', event => {
  console.log('🔧 Service Worker installing v3.86...');
  event.waitUntil(
    caches.open(CACHE_NAME).then(cache => {
      console.log('✅ Cache opened v3.86');
...
self.addEventListener('activate', event => {
  console.log('🚀 Service Worker activating v3.86...');
  event.waitUntil(
...
console.log('✨ ANB FinAdmin Service Worker Loaded v3.86 - Cache Updated!');
