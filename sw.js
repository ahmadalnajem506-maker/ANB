...
self.addEventListener('install', event => {
  console.log('🔧 Service Worker installing v2.81...');
  event.waitUntil(
    caches.open(CACHE_NAME).then(cache => {
      console.log('✅ Cache opened v2.81');
...
self.addEventListener('activate', event => {
  console.log('🚀 Service Worker activating v2.81...');
  event.waitUntil(
...
console.log('✨ ANB FinAdmin Service Worker Loaded v2.81 - Cache Updated!');
